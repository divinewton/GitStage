    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("New clones are stored in a GitOrigin folder inside the location you choose.")
            }
            ...
            Section {
                ...
                Text("GitOrigin detects common editors automatically. Choose a custom app if yours is not listed in Open In menus.")
            }
            ...
            Section {
                ...
                Text("GitOrigin uses the first Git binary it finds from Xcode, Command Line Tools, or Homebrew.")
            }
        }
        .formStyle(.grouped)
        .padding(20)
